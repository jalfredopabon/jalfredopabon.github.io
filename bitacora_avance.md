...
| 2026-04-12 | Refinamiento Hero & Toolkit | Momento 1 | Limpieza editorial (eliminación de fondos), tabs con línea animada y liberación del Toolkit del contenedor 'max-w-6xl' para visibilidad total en móviles. Restaurada versión extendida del manifiesto: 'Soy psicólogo y analista de datos... (Kobo, Google Forms, Sheets, Antigravity, Power BI, Looker Studio)'. |
